...
<blockquote>
<sub><strong>Примечание:</strong> <a href="http://tehgam.com/viewtopic.php?f=11&t=6">Пособие по онлайн этикету</a>.</sub>
</blockquote>
<table>
  <thead>
...
<strong><a href="https://github.com/vosur">[SO]vosur</a></strong>, <strong><a href="https://github.com/tym32167">tym32167</a></strong>, <strong><a href="http://www.tehgam.com/memberlist.php?mode=viewprofile&u=66">[K]STELS]</a></strong> — выполняют роль «вышестоящей инстанции»могут и могут, при необходимости, вне очереди рассмотреть любую заявку, по любым нарушениям, а также измененть уже существующую меру наказания или полностью снять любую блокировку.
          ...
          <li>
            ...
            <p>
Должны рассматриваться не более 2-ух суток (48 часов), с момента их оформления. В случае отсутствия на форуме всех старших администраторов и самого администратора, выписавшего блок — если по истечению 48 часов она всё ещё активна — заявку вправе рассмотреть любой игровой администратор у которого есть доступ к администрированию сервера, на котором был заблокирован игрок.
            </p>
          </li>
        </ul>
        <h4>Часть 1</h4>
...
Командные игры, организованные исключительно в режиме ПВП (две или более сторон), на максимальном уровне сложности, с использованием определённой сборки аддонов, включая аддон ДВ/КВ радиостанций, на основе принципов управления армейского командования в масштабах: отделение/взвод/рота. Специально для этого наши картоделы, или активные участники создают уникальные сценарии и инструктажи, оформление и т. д., а затем воплощают свои идеи в неисчерпаемом возможности редакторе Arma 3.
        ...
        <ul>
          <li>
Несоблюдение таковых может повлечь за собой удаление Вас с сервера без предупреждения, а в ряде случаев и блокировка на все серверы Russian War, будьте внимательны. Администрация будет реагировать на пожелания или просьбы, но убедительная просьба относиться ко всему с уважением.
          </li>
        </ul>
...
После инструктажа, при готовности всех к игре, администратор сервера прогружает всех в саму игру. Игроки, входящие в составы отделений или групп должны подчиняются своему командиру. Командир имеет права расстрелять за неисполнение приказа — при крайней необходимости, например, если боец неуправляем, опасен для своего подразделения или для дружественных войск и т. д.
    ...
    <tr>
      <td>
        ...
        <ul>
          <li>
            <h5>При передаче любой информации</h5>
            <p>
Боец должен сначала передать свой позывной (ник), только после передавать информацию. Если боец запрашивает своего товарища, боец сначала запрашивает позывной своего товарища, потом говорит свой позывной, после передаёт информацию. Таким образом передаётся информация и чтобы всегда любой боец другого отделения (группы, подразделения и т. д.) понимал кто запрашивает и кого запрашивают.
            </p>
            <h6>Например</h6>
            <p>
...
<em>«Принял, Снегирь, отбой».</em> «Отбой» говорят, когда точно всё всем ясно и радиообмен окончен. Таким образом, в этом случае и «Снегирь» мог завершить связь на одну радиопередачу раньше, передав — <em>«Понял тебя, Мороз, отбой».</em>
          ...
          <hr>
          <li>
            <h5>При масштабных сражениях</h5>
            <p>
Может быть чуть посложнее — позывные отделений (групп, подразделений и т. д.) назначаются условно.
            </p>
            <ul>
              <li>
                <h6>Передача</h6>
                <p>
Боец сначала передаёт позывной своего отделения (группы, подразделения и т. д.), потом свой позывной, потом позывной вызываемого отделения/подразделения/группы, потом позывной вызываемого (радиста или точно кого-либо из подразделения), после уже передаёт информацию.
                </p>
              </li>
              <li>
                <h6>Вызов</h6>
