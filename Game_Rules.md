...
<p align="right"><sup><blockquote>Дата последнего обновления правил: <strong>15.01.2015</strong></blockquote></sup></p>
<p>
Нижеуказанные десять пунктов характеризуют основные правила поведения, которые мы ожидаем и требуем от всех игроков участвующих на нашей линейке, а также смежных игровых серверах под зонтиком проекта <a href="http://www.tehgam.com/">TEHGAM</a>.
</p>
<table>
...
Запрещены оскорбления, любые провокации — хамство, неприличные высказывания и т. д. — и угрозы в адрес администрации, или игроков.
          ...
          <hr>
          <li>
Запрещено играть без заполненного никнейма. Строго запрещено содержание в никнейме любых нецензурных или оскорбительных фраз, на любой почве — межрасовая, межнациональная, религиозная или личная неприязнь — а также их подтекстов. Запрещены глаголы, обращения и т.п., дабы не вводить игроков в замешательство при радиообмене или общении через игровой чат. Никнейм должен быть позывным, т.е. легко-произносимым и читаемым словом, словосочетанием или слогом, а не труднопроизносимым набором символов или букв. В случае отказа игроком изменить любой свой никнейм по просьбе администратора, игрок может быть удалён с сервера, а рецидивы или настойчивость игрока могут пресекаться более строго, но в соответствии с мерами наказаний соответствующих пунктов правил.
            <blockquote>
<sub><strong>Примечание:</strong> Никнейм, содержащий прямые или косвенные оскорбления игроков или администрации может классифицироваться, как нарушение <em>п.3 основных правил</em>.</sub>
          ...
          <hr>
          <li>
Запрещена как реклама, так и плагиат сторонних серверов и иных интернет-ресурсов.
          </li>
          <hr>
          <li>
Запрещены любые сторонние программы или хак-средства, изменяющие игровой процесс или физику в игре:
          ...
          <hr>
          <li>
Запрещено намеренное использование багов игры. О замеченных багах следует сообщать в первую очередь администрации сервера, а при надобности и самим разработчикам игры (<a href="https://www.bistudio.com/">BIS</a>) и/или авторам конкретной миссии.
          </li>
          <hr>
          <li>
...
<p>
Соблюдая даже только вышеуказанные основные правила, Вас уже точно не заблокируют или выгонят с сервера, с вероятностью в 99%. <em>Приятной игры!</em>
</p>
<blockquote>
