...
Запрещено наносить любой преднамеренный вред своей команде или процессу игры в целом:
            <ul>
              ...
              <li>Флуд;</li>
              <li>Передача оперативной или любой другой информации друж.войск противоположной команде и т.п.</li>
            </ul>
          </li>
          <hr>
          <li>
...
Нецензурная лексика, в пределох разумного, на сервере не запрещена.
            ...
            <blockquote>
<sub><strong>Примечание:</strong> Наказание за чрезмерное использование нецензурной лексики автоматически признаётся правомерным, т. е. не стоит ей увлекаться настолько, чтобы Вами из-за этого заинтересовалась администрация.</sub>
            </blockquote>
          </li>
          <hr>
          <li>
...
В случае отказа изменить свой никнейм по просьбе администратора, игрок может быть удалён с сервера или — в случае с рецидивом — пресечён еще более строго, тем не менее в соответствии с положениями соответствующих правил.
            ...
            <blockquote>
<sub><strong>Примечание:</strong> Никнейм содержащий прямые или косвенные оскорбления игроков или администрации может классифицироваться как нарушение <em>3-его пункта</em>.</sub>
            </blockquote>
          </li>
          <hr>
          <li>
Запрещена как реклама, так и плагиат сторонних игровых серверов или иных интернет-ресурсов.
          ...
          <hr>
          <li>
Запрещено использование любых сторонних программ, а также методов взлома, изменяющих нормальный игровой процесс в целях получения несправедливого преимущества или нарушения общего порядка:
            <ul>
              <li>Чить-коды</li>
              <li>Обход системы <a href="http://www.battleye.com/">BattlEye</a></li>
              <li>Модульные чит-моды и т. д.</li>
            </ul>
          </li>
          <hr>
          <li>
Запрещено намеренное использование багов игры. О замеченных багах следует сообщать в первую очередь администрации сервера (<a href="https://www.tehgam.com/">TEHGAM</a>), а при надобности и самим разработчикам игры (<a href="https://www.bistudio.com/">BIS</a>) и/или авторам конкретной миссии.
          </li>
          <hr>
          <li>
Запрещено игнорировать запросы по радиосвязи или чату игры от администрации либо других игроков сервера.
          </li>
          <hr>
          <li>
Запрещено игнорировать свои обязанности согласно выбранной штатной специальности, особенно если в миссии сервера есть классовые ограничения на функции или конкретные вещи инвентаря. В большинстве случаев, в списке критически-важных ролей всегда есть:
            <ul>
              <li>Медик — лечит и поднимает раненых;</li>
              <li>Механик — ремонтирует морскую, наземную и авиатехнику;</li>
              <li>Оператор БПА — управляет разведывательной и боевой беспилотной техникой.</li>
            </ul>
              <blockquote>
<sub><strong>Примечание: </strong> Сервер это общая игровая площадка, а не место для частных тренировок. Для обучения, в разделе УЧИТСЯ есть неплохой набор курсов, а для практики у вас в распоряжении РЕДАКТОР миссий, где вы можете бродить по песочнице без забот об обязательствах вытекающих из совместных режимов.</sub>
              </blockquote>
          </li>
          <hr>
          <li>
Запрещено брать или занимать наградную технику — появляющуюся на базе после успешного выполнения Допзадания — не спросив и получив на то разрешения её владельца. Первоочередное право на любую конкретную награду имеют только игроки непосредственно выполнявшие соответствующее Допзадание.
          </li>
        </ol>
      </td>
    </tr>
...
<p>
Соблюдая уже только вышеуказанные основные правила Вы можете быть на 99% уверены что у Вас не будет неприятностей не на одном из наших серверов. Приятной игры!
</p>
<blockquote>
...
<p align="center"><sub>[ последнее обновление: <strong><tt>25.01.2015</tt></strong>]</sub></p>
