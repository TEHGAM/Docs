...
Запрещено намеренное использование багов игры.
            ...
            <p>
О замеченных багах следует сообщать в первую очередь администрации сервера (<a href="https://www.tehgam.com/">TEHGAM</a>), а при надобности и самим разработчикам игры (<a href="https://www.bistudio.com/">BIS</a>) и/или авторам конкретной миссии.
            </p>
          </li>
          <hr>
          <li>
...
<p align="center"><sub>[ последнее обновление: <strong><tt>28.01.2015</tt></strong>]</sub></p>
